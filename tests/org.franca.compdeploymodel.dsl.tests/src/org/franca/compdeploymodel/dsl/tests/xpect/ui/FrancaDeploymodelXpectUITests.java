package org.franca.compdeploymodel.dsl.tests.xpect.ui;
...
import org.franca.compdeploymodel.dsl.tests.xpect.FrancaDeploymodelXpectTests;
	...
	protected ISetup doGetSetup() {
		return new ISetup() {
			...
			public Injector createInjectorAndDoEMFRegistration() {
				return FDeployActivator.getInstance().getInjector(FDeployActivator.ORG_FRANCA_COMPDEPLOYMODEL_DSL_FDEPLOY);
			}
		};
	}
