...
abstract class AccessMethodGenerator {
	...
	@Inject extension org.franca.compdeploymodel.dsl.generator.internal.ImportManager
	
	def generateAccessMethods (FDSpecification spec, boolean forInterfaces, org.franca.compdeploymodel.dsl.generator.internal.ICodeContext context) '''
	...
	def private genProperty(FDPropertyDecl pd, FDPropertyHost host, boolean forInterfaces, org.franca.compdeploymodel.dsl.generator.internal.ICodeContext context) {
	...
	def private genProperty(
		...
		org.franca.compdeploymodel.dsl.generator.internal.ICodeContext context
	) {
