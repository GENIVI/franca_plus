...
public class NewFidlFile extends Wizard implements INewWizard {
	private NewFidlFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for NewIdlFile.
	 */
	public NewFidlFile() {
		super();
	...
	public void addPages() {
		page = new NewFidlFileWizardPage(selection);
		addPage(page);
	}
	...
	private InputStream openContentStream(String packageName, String fileName) {
		String contents =
			"package " + packageName + "\n\ninterface " + fileName.replace(".fidl", "") + " {\n}";
