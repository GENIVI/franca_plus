 ...
 * "fcdl". If a sample multi-page editor (also available
 * as a template) is registered for the same extension, it will
 * be able to open it.
 */

public class NewFcdlFile extends Wizard implements INewWizard {
	private NewFcdlFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for NewFcdlFile.
	 */
	public NewFcdlFile() {
		super();
	...
	public void addPages() {
		page = new NewFcdlFileWizardPage(selection);
		addPage(page);
	}
