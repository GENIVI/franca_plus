...
*******************************************************************************/
package org.franca.compdeploymodel.dsl.ui.internal;

import org.franca.compdeploymodel.dsl.ui.internal.FDeployActivator;
...
public class FDeployAdaptiveActivator extends FDeployActivator {
	...
	protected Module getUiModule(String grammar) {
		if (ORG_FRANCA_COMPDEPLOYMODEL_DSL_FDEPLOY.equals(grammar)) {
			boolean jdtAvailable = isJDTAvailable();
			if (jdtAvailable) {
				System.out.println("Franca Deployment: JDT is available.");
				return new org.franca.compdeploymodel.dsl.ui.FDeployUiModule(this);
			} else {
				System.out.println("Franca Deployment: JDT is not available.");
				return new org.franca.compdeploymodel.dsl.ui.FDeployUiModuleWithoutJDT(this);
			}
		}
